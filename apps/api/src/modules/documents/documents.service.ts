    ...
    const html = `
      ...
      <body>
        ...
        <div class="notes">
          ...
          7. Експертний висновок № XB-000136 п/26 від 01.06.2026р. виданий Вінницькою регіональною державною лабораторією ДСУ з питань безпечності харчових продуктів та захисту споживачів.<br>
        </div>
